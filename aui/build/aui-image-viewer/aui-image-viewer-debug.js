...
}, '1.0.1' ,{skinnable:true, requires:['anim','aui-overlay-mask','substitute']});
...
AUI.add('aui-image-viewer', function(A){}, '1.0.1' ,{use:['aui-image-viewer-base','aui-image-viewer-gallery'], skinnable:true});
